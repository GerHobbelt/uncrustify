 ...
 * asn1_const_ctx are exactly the same.  Fortunately, as soon as the old
 * ASN1 parsing macros are gone, we can throw this away as well...
 */
...
typedef struct asn1_string_st
{
	 ...
	 * is mostly being used for BIT_STRING so if the input data has a non-
	 * zero 'unused bits' value, it will be handled correctly
	 */
	long flags;
} ASN1_STRING;
 ...
 * once you've got them 95% right through uncrustify and that extra 5% by
 * hand ;-)
 */
